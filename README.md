...
[![NPM version](<https://img.shields.io/npm/v/sparkcrm.svg?label=npm%20(stable)>)](https://npmjs.org/package/sparkcrm) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/sparkcrm)
...
const { data: entrypoints, response: raw } = await client.entrypoints.list().withResponse();
...
```ts
import SparkCRM from 'npm:sparkcrm';
...
We are keen for your feedback; please open an [issue](https://www.github.com/gepetojj/spark-typescript-sdk/issues) with questions, bugs, or suggestions.
